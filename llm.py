...
class llm_solution:
    ...
    def image_to_text(self, img_path):
        ...
        prompt = ("Внимательно проанализируй картинку и расшифруй, что на ней написано. "
                  ...
                  "Если ты уверен, что на предоставленном скане есть текста, то в ответе представь только расшифрованный текст с той же структурой, что и на картинке ")
    ...
    def tei_generation(self, original_text, img_path):
        ...
        prompt = ("Тебе предоставлен расшифрованный текст рукописи и ностоящий скан этой рукописи. "
